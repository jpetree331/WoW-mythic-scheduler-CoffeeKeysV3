...
CREATE TABLE v3_history (
  id INTEGER PRIMARY KEY, event_id TEXT NOT NULL REFERENCES v3_events(id) ON DELETE CASCADE,
...
CREATE TABLE v3_claims (player_id TEXT PRIMARY KEY REFERENCES v3_players(id) ON DELETE CASCADE, token_hash TEXT UNIQUE NOT NULL, expires_at INTEGER NOT NULL);
